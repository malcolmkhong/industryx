...
CREATE TABLE IF NOT EXISTS game_config_game (
  ...
  auto_sell_multiplier NUMERIC,
  min_power_efficiency NUMERIC,
  worker_power_reduction_cap NUMERIC,
  rp_extractor_rate NUMERIC,
  rp_power_rate NUMERIC,
  rp_factory_t1_rate NUMERIC,
  rp_factory_t2_rate NUMERIC,
  rp_factory_t3_rate NUMERIC,
  rp_factory_t4_rate NUMERIC,
  event_trigger_interval INTEGER,
  event_trigger_chance NUMERIC,
  max_concurrent_events INTEGER,
  worker_xp_rate NUMERIC,
  worker_levelup_xp_base INTEGER,
  t5_drain_rate NUMERIC,
  market_cycle_expansion_min INTEGER,
  market_cycle_expansion_max INTEGER,
  market_cycle_peak_min INTEGER,
  market_cycle_peak_max INTEGER,
  market_cycle_recession_min INTEGER,
  market_cycle_recession_max INTEGER,
  market_cycle_recovery_min INTEGER,
  market_cycle_recovery_max INTEGER,
  market_phase_expansion_mult NUMERIC,
  market_phase_peak_mult NUMERIC,
  market_phase_recession_mult NUMERIC,
  market_phase_recovery_mult NUMERIC,
  market_micro_event_chance NUMERIC,
  market_macro_event_chance NUMERIC,
  market_max_injection_effect NUMERIC,
  market_trade_decay_rate NUMERIC,
  market_mean_reversion_rate NUMERIC,
  market_price_lower_bound NUMERIC,
  market_price_upper_bound NUMERIC,
  save_version INTEGER NOT NULL DEFAULT 22,
  persist_throttle_ms INTEGER,
  forced_save_ms INTEGER,
  max_save_size_bytes INTEGER,
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
