      ...
      return (
        <div className="min-h-screen bg-[#0a0e17] text-gray-100 flex items-center justify-center p-4">
          <div className="max-w-md w-full text-center space-y-4">
            <div className="w-16 h-16 mx-auto rounded-xl bg-red-900/30 flex items-center justify-center">
            ...
            {this.state.error && (
              <details className="text-left text-xs text-gray-500 bg-gray-900/50 rounded-lg p-3 border border-gray-800">
            ...
            <div className="flex flex-col gap-2 pt-2">
              ...
              <button
                ...
                className="w-full px-4 py-2 rounded-lg bg-red-900/30 hover:bg-red-900/50 border border-red-800/50 text-red-400 text-sm font-medium transition-colors"
              >
                Reset Save &amp; Reload
              </button>
            </div>
