    ...
    <>
      ...
      <div className="hidden lg:flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Tick counter */}
          <div className="text-[10px] text-gray-500 font-mono">Tick: {formatNumber(gameTick)}</div>
              ...
              {notifications.length === 0 ? (
                ...
                <>
                  <div className="flex items-center gap-2 mb-2 pb-1.5 border-b border-gray-800">
                    ...
                    <span className="text-[10px] font-semibold text-gray-300">{unreadNotifications} New</span>
                  </div>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Badge variant="outline" className={`text-[10px] px-1.5 py-0 ${
                weather.current === 'clear' ? 'border-gray-700 text-gray-500 bg-gray-900/20' : 'border-sky-500/50 text-sky-400 bg-sky-900/20'
              }`}>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="sm" className="h-7 px-2 text-xs text-gray-500 hover:text-cyan-400" onClick={() => { setImportString(''); setImportError(''); setImportDialogOpen(true); }}>
            ...
            <Tooltip>
              ...
              <TooltipContent side="bottom" className="w-56 bg-card border-cyan-900/30 p-0 overflow-hidden">
                ...
                <div className="p-2 space-y-1">
                  ...
                  <Button variant="ghost" size="sm" className="w-full justify-start h-7 text-xs text-red-400 hover:text-red-300" onClick={signOut}>
      ...
      <Dialog open={exportDialogOpen} onOpenChange={setExportDialogOpen}>
        <DialogContent className="bg-card border-cyan-900/30">
          ...
          <Textarea
            value={exportString}
            readOnly
            className="font-mono text-xs bg-gray-900/50 min-h-[120px]"
