...
const COLOR_MAP: Record<StatColor, { icon: string; value: string; border: string; bg: string; gradientFrom: string; borderAccent: string }> = {
  ...
  green: { icon: 'text-success', value: 'text-success', border: 'border-success/30', bg: 'bg-green-900/10', gradientFrom: 'from-green-900/20', borderAccent: 'border-l-green-500' },
  ...
  emerald: { icon: 'text-success', value: 'text-success', border: 'border-emerald-900/30', bg: 'bg-emerald-900/10', gradientFrom: 'from-emerald-900/20', borderAccent: 'border-l-emerald-500' },
