...
//   • Client-side: GameConfigProvider fetches /api/game/config/definitions
...
// via @/lib/game/config/balance/balanceConfig getBalance(). It is NOT populated via this
...
import { TIER_INFO } from "../shared/icons/tiers";
...
import { getStreakMultiplier } from "../shared/utils/streakMultiplier";
