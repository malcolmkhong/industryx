...
// saveMigrations.ts
//
// Save version migration (V1→V20) for legacy GameState payloads.
// Extracted from saveMigration.ts for responsibility isolation.
// ============================================
...
import { migrateSaveBuildings } from "../../../migration/idMigration";
import { emptyProductionSnapshot } from "../../../production/productionCalculator";
