...
import {
  GameState, ResourceType, MarketPrice, DroneMission,
} from '../types';
import {
  BUILDING_DEFS, INITIAL_MARKET, INITIAL_MEGA_PROJECTS,
} from '../configCache';
...
export function generateDroneMissionsFromState(state: GameState): DroneMission[] {
...
// --- Save Migration ---
export function migrateSaveState(savedState: Record<string, unknown>, fromVersion?: number): Record<string, unknown> {
