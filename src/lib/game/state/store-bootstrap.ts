...
//   • GET /api/game/state/initial  (fresh guest / first paint)
//   • applyServerState()           (cloud load, refetches via /api/game/state/sync)
//
...
import { emptyProductionSnapshot } from "@/lib/game/production/productionCalculator";
