...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      game_state_recovery_cases: {
        Row: {
          id: string;
          user_id: string;
          original_state_id: string;
          original_state_version: number;
          original_full_state: Json;
          original_payload_schema_version: number | null;
          original_payload_lifecycle: string | null;
          original_payload_checksum: string | null;
          ...
          guest_recovery_reference_hash: string | null;
          created_at: string;
          updated_at: string;
        };
        Insert: {
