...
const navItems: NavItem[] = [
  { label: "Dashboard", icon: "layout-dashboard", href: "/admin", active: true, disabled: false, phase: "" },
  { label: "Players", icon: "user-person", href: "/admin/players", active: false, disabled: false, phase: "" },
  { label: "Investigations", icon: "shield", href: "/admin/investigations", active: false, disabled: false, phase: "" },
  { label: "Player Actions", icon: "scroll", href: "/admin/audit", active: false, disabled: false, phase: "" },
  { label: "Admin Actions", icon: "gavel", href: "/admin/admin-audit", active: false, disabled: false, phase: "" },
  { label: "Config Tables", icon: "database", href: "/admin/config", active: false, disabled: false, phase: "" },
  { label: "Admin", icon: "users", href: "/admin/admins", active: false, disabled: false, phase: "" },
];
