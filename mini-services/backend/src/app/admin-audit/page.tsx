      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        `}>
          <nav className="p-3 space-y-1 border-b border-zinc-800">
            <a href="/backend" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 transition-all">
              <IconDashboard />
              <span>Dashboard</span>
            </a>
            <a href="/config" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 transition-all">
              <IconDatabase />
              <span>Config Tables</span>
            </a>
            <a href="/admins" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 transition-all">
              <IconUsers />
              <span>Admin</span>
            </a>
            <a href="/investigations" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 transition-all">
              <IconShield />
              <span>Investigations</span>
            </a>
            <a href="/audit" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 transition-all">
              <IconScrollText />
                          ...
                          >
                            ...
                            <td className="px-4 py-3">
                              {action.target_user_id ? (
                                <a
                                  href={`/players/${action.target_user_id}`}
                ...
                <div className="flex justify-between py-2 border-b border-zinc-800">
                  ...
                  <span className="text-white text-xs">
                    {detailAction.target_user_id ? (
                      <a href={`/players/${detailAction.target_user_id}`} className="text-amber-400 hover:text-amber-300 transition-colors">
