...
describe('Module: store/composition', () => {
  ...
  it('all 56 actions exist on the store', () => {
    const actions = [
      ...
      'startResearch',
      'hireWorker', 'assignWorker', 'levelUpWorker',
      'sellResource', 'buyResource', 'toggleAutoSell',
      'acceptContract', 'fulfillContract',
      'activateAutomation',
      ...
      'buyDrone', 'sendDrone', 'upgradeDrone', 'generateDroneMissions',
      'addLeaderboardEntry',
      'checkDailyLogin', 'claimDailyReward',
      'claimQuestReward', 'updateQuestProgress', 'setTrackedQuest',
      'upgradeStorage',
      'getCurrentRank', 'getPlayerGameTier',
  ...
  it('store has expected state fields', () => {
    const fields = [
      ...
      'workers', 'market', 'sectorTrends', 'marketNews', 'marketNarratives', 'serverMarket',
      ...
      'leaderboardEntries', 'loginStreak', 'weather', 'quests',
      'payoutConfig', 'pendingPayout', 'payoutHistory', 'trackedQuest', 'drones',
