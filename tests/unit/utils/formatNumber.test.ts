/**
 * TESTS: utils/formatNumber
 *
 * Pure function tests for formatNumber.
 * Maps to target: utils/formatNumber.ts
...
describe('Module: utils/formatNumber', () => {
  ...
  it('formats 1B as "1.00B"', () => {
    expect(formatNumber(1_000_000_000)).toBe('1.00B');
  });

  it('formats 1T as "1.00T"', () => {
  ...
  it('formats negative -1000 as "-1.00K"', () => {
    expect(formatNumber(-1000)).toBe('-1.00K');
  });
});
