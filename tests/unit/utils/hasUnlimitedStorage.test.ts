/**
 * TESTS: utils/hasUnlimitedStorage
 *
 * Pure function tests for hasUnlimitedStorage.
 * Maps to target: utils/hasUnlimitedStorage.ts
...
import { hasUnlimitedStorage } from '@/lib/game/state/store';
...
describe('Module: utils/hasUnlimitedStorage', () => {
  ...
  it('returns true when unlimitedStorage mega project completed', () => {
    const projects = [
